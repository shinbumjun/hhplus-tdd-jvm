...
public class PointServiceTest {
    ...
    @Mock // 실제 포인트 데이터를 관리 (조회 + 충전)
    private UserPointTable userPointTable;

    @Mock // 포인트 충전/사용 내역 저장
    private PointHistoryTable pointHistoryTable;

    private PointService service; // 필드로 선언
    ...
    void getPointTest1() {
        ...
        // When: 실제 호출
        UserPoint result = service.getPoint(userId); // 내부적으로 userPointTable.selectById(userId) 호출
    ...
    void chargeTest1() {
        ...
        // when
        UserPoint result = service.charge(userId, charge);
    ...
    void chargeTest9() {
        ...
        // when
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            service.use(userId, usageAmount);
        });
    ...
    void chargeTest10() {
        ...
        // when
        UserPoint result = service.use(userId, usageAmount);
